...
import OwnerMessaging from './OwnerPages/OwnerMessaging'
    ...
    return (
      <BrowserRouter>
        <div>
          ...
          <Route path='/buyer/message' exact component={Messaging} />
          <Route
          ...
          <Route path='/owner/message' exact component={OwnerMessaging} />
